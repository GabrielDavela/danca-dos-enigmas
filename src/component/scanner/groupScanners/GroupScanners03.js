  ...
  return (
    <>
      ...
      >
        ...
        <a-entity cursor raycaster="far: 200; objects: .clickable" id="camera" position="0 -1 -2" camera look-controls>
          <a-cursor id="cursor" color="purple" fuse="true" fuse-timeout="1000" position="0 0 0"></a-cursor>
        </a-entity>
